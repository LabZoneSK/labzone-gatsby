const messages = {
    ...
    liSliderContent:
        "LinkedIn is the largest business-oriented network, and is always smart to be connected. Let's discuss how we can help each other. Looking forward to connect with you on LinkedIn.",
